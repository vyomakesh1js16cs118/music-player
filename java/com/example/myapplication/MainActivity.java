...
AudioManager audioManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SeekBar volumerack=findViewById(R.id.seekBar);
        final SeekBar timeline=findViewById(R.id.seekBar3);
        ...
        volumerack.setMax(mymaxvolume);

        volumerack.setProgress(mycurrentvolume);

        volumerack.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
